...
type ConventionsConfig =
    { recursiveAsyncFunction:EnabledConfig option
      ...
      avoidUsingResultPropertyOfTaskVariable:EnabledConfig option
...
with
    member this.Flatten() =
        [|
            ...
            this.avoidUsingResultPropertyOfTaskVariable |> Option.bind (constructRuleIfEnabled AvoidUsingResultPropertyOfTaskVariable.rule) |> Option.toArray           
...
with
    static member Zero = {
        ...
        AvoidUsingResultPropertyOfTaskVariable = None
...
let flattenConfig (config:Configuration) =
    ...
    let allRules =
        [|
            ...
            config.AvoidUsingResultPropertyOfTaskVariable |> Option.bind (constructRuleIfEnabled AvoidUsingResultPropertyOfTaskVariable.rule)
